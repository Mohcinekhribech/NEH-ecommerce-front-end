...
const routes: Routes = [
  ...
  {path:'orders',component:OrdersClientPageComponent,},
  ...
  {path:'dashboard/categories',component:CategoriesPageComponent,},
  {path:'dashboard/products',component:ProductsPageComponent,},
  {path:'dashboard/orders',component:OrdersAdminPageComponent,},
  {path:'dashboard/tags',component:TagsPageComponent,},
  {path:'login',component:LoginPageComponent},
  {path:'register',component:RegisterClientPageComponent},
  {path:'',component:HomePageComponent},
  {path:'about',component:AboutComponent},
  {path:'dashboard/products/new',component:AddProductPageComponent,},
  {path:'dashboard/products/update/:id',component:UpdateProductPageComponent,},
];
